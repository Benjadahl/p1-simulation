    ...
    for (i = 0; i < argc; i++) {
        ...
        if (argv[i][0] == '-') {
            ...
            if ((argv[i][1] != 'g' && argv[i][1] != 'b')
                ...
                case 'o':
                    config.toMeet[2].expectedValue = isValueCorrect(config.toMeet[2].expectedValue, value, config.toMeet[2].lowerbound, config.toMeet[2].upperbound);
                    break;

                case 'u':
                    config.toMeet[3].expectedValue = isValueCorrect(config.toMeet[3].expectedValue, value, config.toMeet[3].lowerbound, config.toMeet[3].upperbound);
                    break;
                }
            }
        }
